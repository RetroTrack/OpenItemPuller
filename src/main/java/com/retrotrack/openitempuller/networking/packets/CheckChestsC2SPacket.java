...
public class CheckChestsC2SPacket {
    public static void receive(MinecraftServer server, ServerPlayerEntity player, ServerPlayNetworkHandler handler,
        ...
        server.execute(() -> {
            ...
            List<LockableContainerBlockEntity> chestBlockEntityList = ChestFinder.findSortedLootableContainerBlockEntitiesAroundPlayer(player.getServerWorld(), player, radius); // Replace 128 with config value once done!
